(async() => {
    ...
    let logoWrapperElm = document.getElementsByClassName('MainLogoWrapper')[0];

    let buttonContainer = document.createElement('div');
    buttonContainer.setAttribute('style', "margin: 0 auto 20px auto; width: 200px;")
    let downloadBtn = document.createElement('button');
    downloadBtn.setAttribute('style', 'width: 200px; height: 50px; font-size: 20px;')
    downloadBtn.onclick = downloadData;
    downloadBtn.innerHTML = "Download my data &#8681;";
    buttonContainer.append(downloadBtn);
    logoWrapperElm.insertAdjacentElement('afterend', buttonContainer);
